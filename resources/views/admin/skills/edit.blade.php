    ...
    <form action="{{ route('admin.skills.update', $skill) }}" method="POST">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('name', $skill->name) }}" required>
                @error('name')
            ...
            <div>
                ...
                <div class="mt-1 flex items-center gap-4">
                    <input type="range" name="percentage" id="percentage" min="0" max="100" class="w-full" value="{{ old('percentage', $skill->percentage) }}" oninput="updatePercentageValue(this.value)">
                    <span id="percentageValue" class="text-sm text-gray-600">{{ $skill->percentage }}%</span>
                </div>
                @error('percentage')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="text" name="icon" id="icon" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('icon', $skill->icon) }}" placeholder="fas fa-code">
